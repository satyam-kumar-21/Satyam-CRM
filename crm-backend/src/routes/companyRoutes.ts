...
import { companyLoginValidation, createEmployeeValidation, createGroupValidation, postMessageValidation, leadValidation, saleValidation } from '../validators/companyValidator';
